...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sagemaker-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14991&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sagemaker-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sagemaker` can be installed with:

```
conda install sagemaker
```

It is possible to list all of the versions of `sagemaker` available on your platform with:
